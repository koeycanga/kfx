...
public abstract class View {
   ...
   protected boolean isClicked = false;
    ...
    public void setLx(double lx) {
        this.lx = lx;
        this.rx = lx+width;
        this.posiLX = this.lx + this.getViewGroupPosiLX(this.parentViewGroup);
        this.posiRX = this.posiLX+width;
    }
    ...
    public void setLy(double ly) {
        this.ly = ly;
        this.ry = ly+height;
        this.posiLY = this.ly +this.getViewGroupPosiLY(this.parentViewGroup);
        this.posiRY = this.posiLY+height;
    }
